<footer class="w-full p-8 flex flex-col items-center justify-center gap-8">
    <div class="w-full px-[20vw] flex items-center justify-center gap-4 capitalize text-gray-500 text-md">
